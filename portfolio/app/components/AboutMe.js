            ...
            <div className='pt-[64px] max-w-[1280px] mx-auto px-4 pb-3 md:max-w-[920px] md:pt-[120px]'>
                ...
                <div className='flex items-center gap-3 flex-wrap'>
                    <Pills>
                        ...
                        <Link className='text-[10px] md:text-sm text-white' href="www.linkedin.com/in/jai-soneji">
                            <span>LinkedIn</span>
                        </Link>
                    </Pills>
                    <Pills>
                        ...
                        <Link className='text-[10px] md:text-sm text-white' href="https://github.com/jaisoneji/">
                            <span>GitHub</span>
                        </Link>
                    </Pills>
                    <Pills>
