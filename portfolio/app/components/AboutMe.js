        ...
        <RoughNotationGroup show={true}>
            <div className='pt-[64px] max-w-[1280px] mx-auto px-4 md:max-w-[980px] md:pt-[120px]'>
                ...
                <div className='flex items-center gap-3 flex-wrap'>
                    <Pills>
                        <Link target="_blank" className='text-[10px] md:text-sm text-white flex justify-center items-center gap-[2px]' href="https://www.linkedin.com/in/jai-soneji/">
                    ...
                    <Pills>
                        <Link target="_blank" className='text-[10px] md:text-sm text-white flex justify-center items-center gap-[2px]' href="https://github.com/jaisoneji/">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="15" height="15" viewBox="0 0 15 15" fill="none">
                    ...
                    <Pills>
                        ...
                        <Link className='text-[10px] md:text-sm text-white flex justify-center items-center gap-[2px]' href="mailto:jai.soneji@gmail.com">
                    ...
                    <Pills>
                        ...
                        <a className='text-[10px] md:text-sm text-white flex justify-center items-center gap-[2px]' href="/resume/jai_soneji_resume.pdf">
